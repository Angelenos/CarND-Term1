...
def get_x_coord(y):
    if lane_left.bestx is not None and lane_right.bestx is not None:
        x_left = lane_left.best_fit[0] * y ** 2 + lane_left.best_fit[1] * y + lane_left.best_fit[2]
        x_right = lane_right.best_fit[0] * y ** 2 + lane_right.best_fit[1] * y + lane_right.best_fit[2]
    else:
        x_left = x_right = None
    return x_left, x_right


def lane_detect(image, cam_mtx, dist_coef):
